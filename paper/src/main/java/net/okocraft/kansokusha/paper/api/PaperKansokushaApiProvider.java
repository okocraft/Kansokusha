...
@ApiStatus.Internal
public final class PaperKansokushaApiProvider implements KansokushaApiProvider {

    private static final AtomicReference<KansokushaApi> PUBLISHED = new AtomicReference<>();

    public static void publish(KansokushaApi api) {
    ...
    public static void unpublish(KansokushaApi api) {
        Objects.requireNonNull(api, "api");
