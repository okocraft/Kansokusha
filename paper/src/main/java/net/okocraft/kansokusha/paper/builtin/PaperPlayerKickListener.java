 ...
 * replace the reason.
 *
 * <p>Paper 26.2 continues an accepted kick into disconnect processing and later emits a
 * {@link org.bukkit.event.player.PlayerQuitEvent}. The kick and quit are intentionally distinct:
 * this event records cause/reason at the kick boundary, while quit records the session end.</p>
 */
@ApiStatus.Internal
@NotNullByDefault
public final class PaperPlayerKickListener {
